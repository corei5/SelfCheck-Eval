...
login(token="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")  # Replace with your Hugging Face token

# Set configurations
torch_dtype = torch.float16
base_model = "meta-llama/Llama-3.1-8B-Instruct"
output_dir = "./fine_tuned_llama3.1_mnli"                                                                               
device_map = "auto"
...
model = AutoModelForSequenceClassification.from_pretrained(
    ...
    use_auth_token=True,  # Ensure the token is used for loading model files
)
