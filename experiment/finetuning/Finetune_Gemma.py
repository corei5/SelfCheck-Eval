...
HUGGINGFACE_TOKEN = "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"  # Replace with your token
login(token=HUGGINGFACE_TOKEN)

# Set configurations
torch_dtype = torch.float16
base_model = "google/gemma-7b-aps-it"
output_dir = "./fine_tuned_gemma7B_mnli"
device_map = "auto"
...
tokenizer = AutoTokenizer.from_pretrained(base_model, trust_remote_code=True, use_auth_token=HUGGINGFACE_TOKEN)
...
peft_config = LoraConfig(
    ...
    bias="none",
    task_type="SEQ_CLS",
    target_modules=["q_proj", "v_proj"],  # Adapted for Gemma
)
